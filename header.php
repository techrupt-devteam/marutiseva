        ...
        <div class="col-lg-5 col-md-5 col-8 pr-0">
          <div class="top-bar-event ts-top">
            <ul class="list-inline">
              <li class="topbar_item topbar_item_type-contact_timing"> <img src="assets/images/icon/phone.svg" style="width: 20px;"/> <a href="tel:8390446644">+91 83904 46644</a> </li>
              <li class="topbar_item topbar_item_type-email"> <img src="assets/images/icon/mail.svg" style="width: 20px;"/> <a href="mailto:enquiry@marutiseva.com">enquiry@marutiseva.com</a> </li>
            </ul>
          </div>
          <!-- Top Bar Text End --> 
        </div>
      ...
      <div class="col-lg-6 col-sm-6">
        <div class="topbar-right text-right">
          <ul class="list-inline">
            ...
            <li> <a href="http://commercial.marutiseva.com" class="nexaLogo"> <img src="assets/images/commercial.svg" class="lazyload" ></a> </li>
          </ul>
        </div>
      </div>
    </div>
...
<header id="header_nav" class="header sticky-top ">
  <div class="menu-container header-angle"> <a href="https://www.marutiseva.com" class="logo">
    <picture>
      ...
      <img src="assets/images/logo.png" class="lazyload"> </picture>
    </a>
    <div class="menu">
      <ul id="menu" class='menu'>
        ...
        <li class="dropdown mega-dropdown menu-dropdown-icon"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Our Product <!--<span class="caret"></span>--> </a>
